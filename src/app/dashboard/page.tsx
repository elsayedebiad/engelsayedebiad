...
import { CVStatus, Priority, SkillLevel, Role } from '@prisma/client'
import {
  Search,
  FileText,
  User,
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-6 mb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800">إعدادات صفحات المبيعات</h3>
                    <p className="text-gray-600 text-sm mt-1">إدارة أرقام الواتساب لصفحات Sales 1-5</p>
                  </div>
                </div>
                <button
                  onClick={() => router.push('/dashboard/sales-config')}
                  className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl"
                >
              ...
              <div className="mt-4 grid grid-cols-2 sm:grid-cols-5 gap-3">
                {['sales1', 'sales2', 'sales3', 'sales4', 'sales5'].map((salesId, index) => (
                  <button
                    ...
                    className="bg-white hover:bg-gray-50 border border-gray-200 rounded-lg p-3 text-center transition-all duration-200 hover:shadow-md"
                  >
                    <div className="text-sm font-medium text-gray-800">Sales {index + 1}</div>
                    <div className="text-xs text-gray-500 mt-1">عرض الصفحة</div>
                  </button>
                ))}
              </div>
            </div>
