...
export default function SalesConfigPage() {
  ...
  const salesPages = [
    { id: 'gallery', name: 'المعرض الرئيسي', color: 'from-blue-500 to-cyan-500', bgColor: 'bg-blue-50', borderColor: 'border-blue-200' },
    { id: 'sales1', name: 'Sales 1', color: 'from-green-500 to-blue-500', bgColor: 'bg-green-50', borderColor: 'border-green-200' },
    ...
    { id: 'sales4', name: 'Sales 4', color: 'from-indigo-500 to-blue-500', bgColor: 'bg-indigo-50', borderColor: 'border-indigo-200' },
      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">إدارة أرقام الواتساب لكل صفحة مبيعات</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {salesPages.map((page) => {
            ...
            return (
              <div
                key={page.id}
                className={`bg-white rounded-lg shadow-lg border-2 ${page.borderColor} overflow-hidden hover:shadow-xl transition-all duration-300`}
              >
                {/* Card Header */}
                <div className={`${page.bgColor} p-4 border-b ${page.borderColor}`}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-800">{page.name}</h3>
                        <p className="text-sm text-gray-600">صفحة معرض السير الذاتية</p>
                      </div>
                    </div>
                    
                    <button
                      onClick={() => openSalesPage(page.id)}
                      className="bg-white hover:bg-gray-50 text-gray-700 p-2 rounded-lg transition-colors border border-gray-200"
                      title="فتح الصفحة"
                    >
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <h4 className="text-sm font-medium text-gray-700 mb-2">معلومات الصفحة:</h4>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-blue-800 mb-2">تعليمات الاستخدام</h3>
