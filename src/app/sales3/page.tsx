    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6" dir="rtl">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4 sm:p-6 mb-6">
          <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="bg-gradient-to-r from-orange-100 to-red-100 p-2 sm:p-3 rounded-lg flex-shrink-0">
                <Grid3X3 className="h-5 w-5 sm:h-6 sm:w-6 text-orange-600" />
              </div>
              <div className="min-w-0 flex-1">
                <h1 className="text-lg sm:text-2xl font-semibold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent truncate">
                  معرض السير الذاتية
                </h1>
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4 sm:p-6 mb-6">
          ...
          {/* الفلاتر المتقدمة */}
          {showAdvancedFilters && (
            <div className="bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 rounded-2xl p-4 sm:p-6 border border-orange-100 mb-4 sm:mb-6">
