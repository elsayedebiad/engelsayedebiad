      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="bg-gradient-to-r from-pink-100 to-rose-100 p-3 rounded-lg">
                <Grid3X3 className="h-6 w-6 text-pink-600" />
              </div>
              <div>
                <h1 className="text-2xl font-semibold bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent">
                  معرض السير الذاتية
                </h1>
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4 sm:p-6 mb-6">
          <div className="mb-6 sm:mb-8">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pr-10 sm:pr-14 pl-4 sm:pl-6 py-3 sm:py-5 border-2 border-gray-200 rounded-xl sm:rounded-2xl focus:ring-2 sm:focus:ring-4 focus:ring-pink-100 focus:border-pink-400 transition-all bg-white text-sm sm:text-lg"
                value={searchTerm}
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 sm:gap-3 mb-4 sm:mb-6">
            ...
            <select
              className="px-3 sm:px-4 py-2 bg-pink-50 border border-pink-200 rounded-lg sm:rounded-full text-xs sm:text-sm font-medium text-pink-700 hover:bg-pink-100 min-w-0 flex-1 sm:flex-initial"
              value={ageFilter}
          ...
          {/* الفلاتر المتقدمة */}
          {showAdvancedFilters && (
            <div className="bg-gradient-to-br from-pink-50 via-rose-50 to-red-50 rounded-2xl p-4 sm:p-6 border border-pink-100 mb-4 sm:mb-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    className="w-full px-3 py-2 border border-rose-200 rounded-lg text-sm focus:ring-2 focus:ring-rose-500 focus:border-transparent"
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      className="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-2 px-2 rounded text-xs flex items-center justify-center"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 bg-red-600 hover:bg-red-700 text-white py-2 px-2 rounded text-xs flex items-center justify-center"
